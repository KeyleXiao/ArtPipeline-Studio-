...
export function layerTypeIcon(layer) {
  if (layer.type === "text") return icon("type");
  if (layer.is_subject || layer.source === "$asset") return icon("star");
  return icon("image");
}
